            ...
            }
            {
                tasks.map(task => {
                    ...
                    return <div key={task._id} className="flex flex-col sm:flex-row w-full text-center shadow-md  rounded-lg overflow-hidden divide-x max-w-2xl dark:bg-gray-900 dark:text-gray-100 divide-gray-700 mt-5">
                        <div className="self-stretch justify-center py-1 flex items-center px-2 flex-shrink-0 dark:bg-gray-700 dark:text-violet-400">
                        ...
                        <button onClick={() => handleComplete(task._id)} className="px-2 justify-center flex items-center text-xs uppercase tracking-wide py-1 dark:text-gray-400 dark:border-gray-700">Complete</button>

                        <button onClick={() => setTask(task)} className="px-2 flex justify-center items-center py-1 text-xs uppercase tracking-wide dark:text-gray-400 dark:border-gray-700">Update</button>
